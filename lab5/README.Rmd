...
compute mean temperature wind speed and atomospheric pressure for each weather station, and pick the weather station with the average value closest to the median for the US.
```{r}
station_averages <-
  met[ , .(
